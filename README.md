...
here is the link to the youtube video demonstrating how the project works:
https://youtu.be/oMN-GvXwW4E?si=mr19z7zJ2xIw59jl

how to run project locally:
Clone repo (preferably using VS code ) 
...
Please check documentation in the repo for those accounts to access the different roles
